...
%% Temporary fixes %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{verbatim}
% TODO: properly handle sourcecode (right now it's just verbatim)
...
Antioch (see the \mncite[following section]{holy_hand_grenade}), that we
...
\mncite[The following depiction]{killer-bunny} of the fearsome beast
has been sourced from
\url{http://camelot.gov.example/avatars/rabbit[Rabbit-SCII]},
\mncite[accompanied]{killer-source}
...
\mn{alt=Holy Hand Grenade of Antioch, in ASCII}
\begin{verbatim}
                        ______
                       \\/  \/
                      __\\  /__
...
\begin{figure}[h]\centering
  \mn{link=https://upload.wikimedia.org/wikipedia/commons/b/bf/Coa_Illustration_Elements_Globus_cruciger.svg,align=right}
  \label{sovereign-orb}
...
of the Holy Hand Grenade of Antioch \att[bcp14]{may} be summarized as
...
\begin{enumerate}
  ...
  \item The Foe, being naughty in the \textbf{LORD's} sight, \att[bcp14]{shall} snuff it
\end{enumerate}
...
\begin{quote}
  ...
  % TODO: properly handle unicode in latex compilation
